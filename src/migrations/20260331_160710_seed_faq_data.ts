...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  payload.logger.info(`Seeding ${faqData.length} FAQ items...`)
  ...
  payload.logger.info('FAQ seeding completed successfully.')
}

export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  payload.logger.info('Down migration: deleting all FAQ items...')
  ...
  payload.logger.info('All FAQ items deleted.')
}
